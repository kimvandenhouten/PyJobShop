...
class ProblemData:
    ...
    _task2modes: list[list[int]] = field(init=False, compare=False)
    _task2resources: list[list[int]] = field(init=False, compare=False)
    _resource2modes: list[list[int]] = field(init=False, compare=False)
